...
const orderedWeek = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'];

const sortMeetingsByDay = (arr) => {
  arr.sort((a, b) => orderedWeek.indexOf(a.dayOfWeek) - orderedWeek.indexOf(b.dayOfWeek));
  return arr;
};
...
const sortSchedule = (arr) => {
  arr.sort((a,b) => {
    return orderedWeek.indexOf(a.dayOfWeek) - orderedWeek.indexOf(b.dayOfWeek) || compare(a.start, b.start) ||
